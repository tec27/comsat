...
Replay.prototype = {
  ...
  _mergeData: function(data, callback) {
    if(!data.header && !data.detail && !data.attributes) { // TODO: add the rest of the data files to this list
          ...
          headerParser.parse(err, data, function onHeaderParsed(err, header) {
            ...
            async.parallel(
            {
              details: function(callback) {
                fs.readFile(detailsFile, function(err, data) { detailsParser.parse(err, data, version, callback); });
              },
              attributes: function(callback) {
                fs.readFile(attributesFile, function(err, data) { attributesParser.parse(err, data, version, callback); });
              },
            },
